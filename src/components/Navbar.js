...
export default function Navbar() {
  ...
  return (
    <nav className="flex flex-col items-center xl:justify-center gap-y-4 xl:fixed h-max bottom-0 mt-auto xl:left-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
